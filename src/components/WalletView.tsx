...
import { Wallet, Coins, CurrencyDollar, Bank, ArrowUp, ArrowDown, Plus, ArrowRight } from "@phosphor-icons/react";
        ...
        {QUICK_ACTIONS.map((action, i) => (
          ...
          >
            <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center mx-auto mb-2 group-hover:bg-amber-500/10 transition-colors">
              <action.icon weight="duotone" className="text-lg text-gray-400 group-hover:text-amber-400 transition-colors" />
            </div>
